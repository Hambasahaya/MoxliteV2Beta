    ...
    <>
      <div ref={ref}>
        <motion.div
          ...
          className="w-full px-[24px] py-[93px] lg:px-[120px] lg:py-[130px] bg-[url(/image/about_banner.jpg)] bg-cover"
        >
          <motion.h1
            initial={{ y: 50, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 1.5, ease: "easeOut" }}
            className="text-start text-white font-bold text-[36px] lg:text-[48px]"
          >
        ...
        <div className="bg-black overflow-hidden relative">
          <motion.div style={{ x: smoothX }} className="relative">
            <div className="flex relative">
              <img src="/image/patners.png" className="h-[80px]" />
              <img src="/image/patners.png" className="h-[80px]" />
            </div>
          </motion.div>
