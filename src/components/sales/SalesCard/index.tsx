        ...
        <div className="border-solid border-1 border-[#cbd5e1] w-full grid grid-cols-12">
            ...
            <div className="w-full h-full flex flex-col p-[24px]">
                   ...
                   <div className="grid grid-cols-12 gap-[24px] mt-[20px]">
                        <div className="col-span-12 lg:col-span-6" >
                            <div className="flex flex-col gap-[20px]">
                                <div className="flex align-start">
                                    <img src={"/icon/location_on_dark.svg"} className="h-[24px] pr-[8px]" />
                                    <p
                                ...
                                <div className="flex align-start">
                                    <img src={"/icon/whatsapp_dark.svg"} className="h-[24px] pr-[8px]" />
                                    <p
                                        rel="noopener noreferrer"
                                        className="text-[16px] font-semibold break-all"
                                    >
                        ...
                        <div className="flex flex-col gap-[20px]">
                            <div className="flex align-start ">
                                <img src={"/icon/mail-dark.svg"} className="h-[24px] pr-[8px]" />
                                <a
                            ...
                            <div className="flex align-start ">
                                <img src={"/icon/instagram-dark.svg"} className="h-[24px] pr-[8px]" />
                                <a
