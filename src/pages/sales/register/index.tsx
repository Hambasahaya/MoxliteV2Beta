      ...
      <Link
          ...
          >
            <div className="flex items-center mr-1 cursor-pointer mb-[40px]">
              ...
              />
              <p className="text-[14px] font-semibold text-[#0F172A]">Back to Sales Partner</p>
            </div>
            </Link>
            ...
            <form onSubmit={handleSubmit}>
                <div className="flex flex-col gap-[24px]">
                    <div>
                        <p className="text-[14px] font-semibold text-[#0F172A] mb-[6px]">Company Name</p>
                        <input
                            type="text"
                    ...
                    <div>
                        <p className="text-[14px] font-semibold text-[#0F172A] mb-[6px]">City</p>
                        <input
                            type="text"
                            placeholder="Enter here"
                            value={data.city}
                    ...
                    <div>
                        <p className="text-[14px] font-semibold text-[#0F172A] mb-[6px]">Country</p>
                        <select  required value={data.country}  onChange={(e) => setData((prev)=>({...prev, country:e.target.value}))} name="country" className="w-full h-[40px] px-3 pr-10 text-[14px] text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                > 
                        <option value="">Select Country</option> 
                        {
                            countries.map((item,idx)=>{
                        return <option value={item} key={`country-${idx}`}>{item}</option> 
                            })
                        }
                    ...
                    <div>
                        <p className="text-[14px] font-semibold text-[#0F172A] mb-[6px]">Phone/WhatsApp Number</p>
                        <input
                            type="text"
                            placeholder="Enter here"
                            value={data.phone}          
                    ...
                    <div>
                        <p className="text-[14px] font-semibold text-[#0F172A] mb-[6px]">Website</p>
                        <input
                            type="text"
                            placeholder="Enter here"
                            required
                    ...
                    <div>
                        <p className="text-[14px] font-semibold text-[#0F172A] mb-[6px]">Instagram Handle (no @)</p>
                        <input
                            type="text"
                            placeholder="Enter here"
                            required
                    ...
                    <div>
                        <p className="text-[14px] font-semibold text-[#0F172A]">Company Profile Google Drive Link</p>
                        <p className="text-[14px]  text-[#71717A] mb-[6px]">Make sure the file is accessible to anyone with the link</p>
                        <input
                            type="text"
                            placeholder="Enter here"
                            required
                            value={data.comproLink}               
                            onChange={(e) => setData((prev)=>({...prev,comproLink:e.target.value}))}
                            className="w-full h-[40px] px-3 pr-10 text-[14px] text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                    </div>
                    <div>
                        <p className="text-[14px] font-semibold text-[#0F172A] mb-[6px]">Why You Want to Become Moxlite Sales Partner</p>
                        <textarea
                ...
                <div className="flex justify-end">
                    <button
                        ...
                        style={{ background:"radial-gradient(116.01% 139.72% at 50% 100%, #020617 33.17%, #081F3B 62.23%, #3E9C92 100%)", color:"white"}}
                    >
                    Register
                    </button>
                </div>
